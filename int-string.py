...
def convert(*_):
	try:
		...
		output = 'Bad entry! Must be integer Number'
...
if __name__ == '__main__':
	...
	root.config(width=470, height=200, bg='dodgerblue')
	root.eval('tk::PlaceWindow . center')
                                          #Number to words converter
	enter_num_lbl = tk.Label(root, text='Enter number to word convert:-', font='consolas', bg='dodgerblue', fg='white')
